/**
 * Create remaining tables with fixed FK constraints (NO ACTION instead of SET NULL)
 */
...
async function main() {
  try {
    ...
    console.log('Creating remaining 9 tables with corrected FK constraints\n');
    ...
    const sqlStatements = [
      ...
      },
      {
        ...
        sql: `CREATE TABLE [service_center_financial] (
          ...
          CONSTRAINT [FK_scf_user] FOREIGN KEY ([last_updated_by]) REFERENCES [users] ([user_id]) ON DELETE NO ACTION
        );`
      },
      {
